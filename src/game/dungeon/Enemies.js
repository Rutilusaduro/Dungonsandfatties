...
export function makeEnemy(def) {
  return {
    ...
    graduationText:  def.graduationText ?? null,
...
export const FLOOR1_ENEMIES = [
  {
    ...
    graduationText: "The pantry floor has new cracks in it — a long trail of split stone running from where she used to sit to the cellar stairs, the shelving along both walls bent inward at hip height. The imp herself is gone. Word arrives three days later from a tinker passing through: something red and vast is wedged behind the baker's oven in the village, warm and completely still, her belly filling the corner from baseboard to hearth. The baker estimates she takes up more floor than the oven does, and has stopped asking how she got there. The bread doesn't burn on the bottom since she arrived. Her wings hang on a nail by the pantry door. Nobody put them there. They were just there one morning.",
    baseWeight: 80,
    stomachCapacity: 90,
    willingness: 45,
  ...
  },
  {
    ...
    graduationText: "The pantry feels wrong without her. The doorframe at the kitchen exit has new gouging along both sides — paint scraped to raw wood in two broad paths at hip height, the floor beneath grooved where something very heavy pushed itself through. She turned up in the village market three days later. The stall nearest the gate has been shortened by a third. She is permanent now: her belly settles across the cobblestones in thick, warm folds, the market routing itself around her. She keeps inventory. She keeps it loudly. No one has dared let the produce go worse. Her spoon is still in her hand. That part didn't change.",
    baseWeight: 140,
    stomachCapacity: 200,
    willingness: 55,
...
export const FLOOR2_ENEMIES = [
  {
    ...
    graduationText: "The hall where she feasted is quiet now, but not cold. The stones hold warmth for a full day after she's gone — more than torchlight leaves, more than the kitchen below accounts for. At the far end there is a wide, shallow depression in the floor where the old stone has been pressed smooth, as if something of considerable soft weight settled there for a long time. You find out later from the innkeeper that the fire in the common room has been running itself for a week. Nobody stokes it. It doesn't go out. Something has settled near the back wall and breathes like a sleeping person. The bread from the kitchen rises three times faster than it should. Nobody goes to look. The inn smells of a feast that started long ago and never quite finished.",
    baseWeight: 160,
    stomachCapacity: 350,
    willingness: 80,
  ...
  },
  {
    ...
    graduationText: "Three of the kitchen rafters are cracked when you pass through — the wood bowed outward and then split, in the shape of something that kept growing until the space stopped fitting it. The oven below is cold. The warmth has moved. Word comes through the tinker trade that the village baker's oven has been running itself, and that there is a copper-skinned presence wedged into the space above it — vast, still, her belly hanging in heavy folds against the brickwork, her hips spreading the rafters wider than they were built to go. The baker's guild sent Boris a note asking what he changed. He has no answer. The oven runs better now, he says, and leaves it at that.",
    baseWeight: 90,
    stomachCapacity: 100,
    willingness: 40,
